    ...
    \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\B13\Container\Tca\Registry::class)->configureContainer(
        (
            new \B13\Container\Tca\ContainerConfiguration(
                ...
                [
                    [
                        ['name' => $L.'left',  'colPos' => 101, 'disallowed' => ['CType' => 't3upheaderimage_content,1cols,2cols,3cols,4cols,image,textpic']],
                        ['name' => $L.'right', 'colPos' => 102, 'disallowed' => ['CType' => 't3upheaderimage_content,1cols,2cols,3cols,4cols,image,textpic']]
                    ]
                ]
                )
            )
